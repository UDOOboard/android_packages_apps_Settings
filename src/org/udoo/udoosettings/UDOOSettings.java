...
public class UDOOSettings extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayTypeKey = getString(R.string.udoo_video_output_key);
    ...
    private void init() {
        ...
        UtilUdoo.Get(AUDIO_DEVICE_PROPERTY, new OnResult<String>() {
            ...
            public void onSuccess(String value) {
                ...
                mAudioDevicePref.setSummary(mAudioDevicePref.getEntry());
            }
        ...
        UtilUdoo.ReadParameter(new OnResult<String>() {
            ...
            public void onSuccess(final String o) {
                ListPreference preference = (ListPreference) getPreferenceManager().findPreference(getString(R.string.udoo_video_output_key));
